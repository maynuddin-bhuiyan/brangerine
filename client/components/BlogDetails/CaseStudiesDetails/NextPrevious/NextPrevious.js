  ...
  return (
    <div className={styles.nextPrevious}>
      <div className={styles.nextPreviousContainer}>
        ...
        <div>
          <div>
                      ...
                      <a href={preLink} className={styles.linkText}>
                          <img src="/images/CaseStudies/arrow left.svg" alt="" />Previous project</a>
        ...
        <div>
          <div>
            <a href={nextLink} className={styles.linkText}>Next project  <img src="/images/CaseStudies/arrow right.svg" alt="" /></a>
